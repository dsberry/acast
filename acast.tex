...
determine how to convert between celestial coordinate systems, the main
...
will, if possible, generate a Mapping from \verb{frame1} to
\verb{frame2}. The return Mapping is encapsulated within a FrameSet that
also includes copies of \verb{frame1} and \verb{frame2}.
