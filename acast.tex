...
\item There was no C++ standard in 1996 when AST development commenced.
...
\item The current architecture of AST makes it difficult for non-Starlink
...
\item The restriction that all coordinate values are represented by
double precision values may be a problem for time axes, which can
sometimes require quad precision.

\item The distinction between a coordinate system and a domain has caused
...
\item Out decision to use radians rather than degrees to represent angle values
