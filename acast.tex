...
represented by a SkyFrame can be changed at any time simply by assigning new
values to any of the relevant attributes.

\subsubsection{Coordinate Conversion within Domains}
\label{sec:domConversion}
Thus given two SkyFrames describing, say, FK5 (RA,Dec) and
...
the \texttt{astConvert} method of the Frame class. For instance, in
Python:
...
support celestial coordinate systems, and also any multi-dimensional data
