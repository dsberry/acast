...
\subsubsection{Methods and Properties of the Mapping Class}
...
(e.g. the sky can be described using ICRS, Galactic, \emph{etc}, the EM
spectrum can be described using freq, wavelength, \emph{etc}). The ``Frame''
